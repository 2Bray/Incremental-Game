...
public class AchievementControllerScript : MonoBehaviour
{
    ...
    private static AchievementControllerScript _instance = null;

    public static AchievementControllerScript Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = FindObjectOfType<AchievementControllerScript>();
            }
            return _instance;
        }
    }
